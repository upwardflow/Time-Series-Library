#!/usr/bin/env python3
"""Run strict paired TimeRole validation on the remaining ETTm horizons."""
...
def import_720_records() -> None:
    ...
    source = ROOT / "logs" / "timerole_validation" / "validation"
    ...
    for dataset in DATASETS:
        for pred_len in PRED_LENS:
            ...
            rows.append({
                ...
                "timerole_duration_seconds": timerole["duration_seconds"],
            })
    return rows
