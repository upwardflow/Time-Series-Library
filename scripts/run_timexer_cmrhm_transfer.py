#!/usr/bin/env python3
"""Validation-only transfer gate for frozen CMRHM-v1 on TimeXer."""
...
def write_summary() -> list[dict]:
    ...
    for dataset, pred_len in TASKS:
        ...
        rows.append({
            ...
            "baseline_mse": baseline["best_mse"], "cmrhm_mse": cmrhm["best_mse"],
            "mse_improvement_pct": 100 * (baseline["best_mse"] - cmrhm["best_mse"]) / baseline["best_mse"],
            "baseline_mae": baseline["best_mae"], "cmrhm_mae": cmrhm["best_mae"],
