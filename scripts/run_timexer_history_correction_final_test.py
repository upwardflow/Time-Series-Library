#!/usr/bin/env python3
"""One-shot test of validation-selected TimeXer/TimeRole checkpoints."""
...
VALIDATION = ROOT / "logs" / "timexer_timerole_transfer" / "validation"
OUTPUT = ROOT / "logs" / "timexer_timerole_final_test"
