#!/usr/bin/env python3
"""Validation-only TimeRole old-history interventions and efficiency audit."""
...
OUTPUT = ROOT / "logs" / "timerole_interventions"
...
def run_one(
    ...
    replace_option(command, "--timerole_old_intervention", intervention)
    replace_option(command, "--timerole_noise_std", "1.0")
