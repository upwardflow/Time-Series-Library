...
run_one ettm2 ETTm2 dataset/ETT-small ETTm2.csv OT t 7 192 2 10
run_one ettm2 ETTm2 dataset/ETT-small ETTm2.csv OT t 7 336 2 10
run_one weather custom dataset/weather weather.csv "CO2 (ppm)" t 21 96 3 20
run_one weather custom dataset/weather weather.csv "CO2 (ppm)" t 21 192 3 20
run_one weather custom dataset/weather weather.csv "CO2 (ppm)" t 21 720 3 20
