#!/usr/bin/env python3
"""Finalize the six-dataset CMRHM report with literature comparisons."""
...
def main() -> int:
    ...
    for row in compared:
        backbone = "周期24+CMRHM" if row["periodic_backbone_active"] else "双Patch+CMRHM"
        lines.append(
    ...
    summary = {
        ...
        "comparison_warning": "CMRHM input=336 vs SimpleTM input=96; TimeCDS is withdrawn and input=672 rolling forecast.",
    }
