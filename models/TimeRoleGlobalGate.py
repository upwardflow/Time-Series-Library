"""Shared-global-gate control for TimeRole."""
...
class Model(TimeRole):
    """Use one shared gate value while retaining identical parameters."""

    def forecast(self, x_enc):
        recent = x_enc[:, -self.recent_len :, :]
        base_output = super(TimeRole, self).forecast(recent)
        ...
        scale = torch.tanh(self.memory_scale.mean())[None, None, None]
